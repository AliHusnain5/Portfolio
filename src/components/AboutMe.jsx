  ...
  return (
    <div id="AboutMe" className="px-4 sm:px-6 md:px-10 py-10">
      <div className="text-shadow-blue-300">
        ...
        {/* Description + Info */}
        <div className="flex flex-col md:flex-row justify-between gap-10 text-base sm:text-lg md:text-xl mt-10">
        ...
        {/* Download Button */}
        <div className="mt-10">
          <button className="group relative overflow-hidden border bg-gray-700 border-white w-full sm:w-80 h-16 rounded-4xl text-base sm:text-lg font-medium">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-10 mt-12">
          {/* Card 1 */}
          <div className="border-2 h-[600px] w-full lg:w-1/2 bg-slate-800 rounded-[40px] flex flex-col items-center justify-between p-6">
          ...
          {/* Card 2 */}
          <div className="border-2 h-[600px] w-full lg:w-1/2 bg-white text-black rounded-[40px] flex flex-col items-center justify-between p-6">
            <div className="flex flex-col items-center space-y-6">
