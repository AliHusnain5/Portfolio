           ...
           <div className="w-full  flex justify-center p-4 mt-15">
            <div className="w-full max-w-[400px] bg-slate-500/50 rounded-[40px] flex flex-col items-center  p-4">
              ...
              <div className="mt-4 flex flex-row items-center justify-center gap-4">
                ...
                <div className="text-3xl  font-bold text-white tracking-wider text-center ">
                  Ali <br /> Husnain
                </div>
              </div>
              ...
              <div
                className="h-[180px] w-[180px]  bg-cover bg-center bg-no-repeat bg-amber-300 rounded-[40px]"
                style={{
